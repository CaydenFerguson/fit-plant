...
const LiveTimeChart = ({
  ...
  useEffect(() => {
    echarts.registerTheme('customTheme', theme.colours.graphing) // Register theme globally
  }, [])
  ...
  const option = useMemo(
    () => ({
      ...
      //   name: plant.name,
      //   data: plant?.data ? plant.data.slice(-48) : [],
      //   type: 'line',
      //   showSymbol: false,
      //   smooth: true,
      //   // type: 'line',
